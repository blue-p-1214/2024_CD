...
<div class="d-none" id="board-free-write">
    ...
    <div class="row">
        <div class="col">
            <div class="mt-2 md-2">
                <label for="board-free-write-subject" class="form-label">제목</label>
                <input type="text" class="form-control" id="board-free-write-subject">
            </div>
            <div class="mt-2 md-2">
                <label for="board-free-write-content" class="form-label">내용</label>
...
<div class="d-none" id="board-free-detail">
    ...
    <div class="row">
        <div class="col">
            <div class="mt-2 md-2">
                <label for="board-free-detail-subject" class="form-label">제목</label>
                <input type="text" class="form-control" id="board-free-detail-subject">
            </div>
            <div class="mt-2 md-2">
                <label for="board-free-detail-content" class="form-label">내용</label>
